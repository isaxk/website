...
<div
    ...
    class="flex flex-col-reverse gap-5 mt-10 mb-14 sm:mt-20 sm:mb-24 sm:flex-row w-full sm:h-40 px-5 self-center items-center border-b-0 border-b-gray-800"
>
    <div class="flex flex-col flex-grow gap-3 text-center sm:text-left">
        ...
        <div class="flex gap-3 items-center">
            <div class="text-md text-gray-400">Casual Web Developer</div>
